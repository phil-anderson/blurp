...
public class BlurpifierTest {
    ...
    private void assertBlocksUntilComplete() {
        ...
        while(!mockRenderer.dormantAsserted) BlurpStore.system.pause(1);
    ...
    private class MockRenderer implements Runnable {
        ...
        public void run() {
            ...
            while(testCandidate.getRequestState() != BlurpifyRequestState.Requested) BlurpStore.system.pause(1);

            if(delayBeforeStateChange) BlurpStore.system.pause(5000);
